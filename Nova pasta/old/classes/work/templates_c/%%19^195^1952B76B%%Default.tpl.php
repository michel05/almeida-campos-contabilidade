<?php /* Smarty version 2.6.25-dev, created on 2015-01-08 15:49:41
         compiled from E:%5Chome%5Calmeidaeca1%5Calmeidaecampos.com.br%5Cweb/classes/components/Text_2%5Clayouts%5CDefault%5CDefault.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'TRANSLATE', 'E:\\home\\almeidaeca1\\almeidaecampos.com.br\\web/classes/components/Text_2\\layouts\\Default\\Default.tpl', 19, false),)), $this); ?>
<style type="text/css">
...
<?php else: ?>
    ...
    <?php echo '<div id="'; ?><?php echo $this->_tpl_vars['properties']['id']; ?><?php echo '_sys_txt" systemElement="true" class="sys_txt sys_text_widget new-text-widget" style="margin:0px; padding:0px; color:'; ?><?php echo $this->_tpl_vars['properties']['color']; ?><?php echo '; font:'; ?><?php echo $this->_tpl_vars['properties']['font']; ?><?php echo '; background-color:'; ?><?php echo $this->_tpl_vars['properties']['backgroundColor']; ?><?php echo ';">'; ?><?php if ($this->_tpl_vars['system']['mode'] == 'DESIGN'): ?><?php echo '<div id="'; ?><?php echo $this->_tpl_vars['properties']['id']; ?><?php echo '_sys_txt_frm_div">'; ?><?php echo $this->_tpl_vars['text']; ?><?php echo '</div><div style="clear:both"></div>'; ?><?php elseif (! $this->_tpl_vars['isDefault']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['text']; ?><?php echo ''; ?><?php endif; ?><?php echo '</div>'; ?>
