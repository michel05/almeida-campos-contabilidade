...
<%else%>
    ...
    <%strip%>   
        <div id="<% $properties.id %>_sys_txt" systemElement="true" class="sys_txt sys_text_widget new-text-widget" style="margin:0px; padding:0px; color:<% $properties.color %>; font:<% $properties.font %>; background-color:<% $properties.backgroundColor %>;">
