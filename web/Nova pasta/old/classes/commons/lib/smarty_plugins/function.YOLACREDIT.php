...
?>
                ...
                <style type="text/css">
                    ...
                    #sys_yolacredit_left {background:url(<?=$yolaTagPNG?>) top left no-repeat;}
                    #sys_yolacredit_center {background:url(<?=$yolaTagPNG?>) -10px top no-repeat;}
                    #sys_yolacredit_right {background:url(<?=$yolaTagPNG?>) top right no-repeat;}
                </style>
                <!--[if lte IE 6]>
                        <style type="text/css">
                ...
                <![endif]-->
                <div id="sys_yolacredit" style="margin: 1em auto;text-align:center; width:220px; display:block; visibility:visible; height:35px"
                     title="<?= _("Visit Yola.com to create your own free website"); ?>">
                    ...
                    <div id="sys_yolacredit_center" style="height:35px; float:left;padding-left:3px; margin:0px; background-repeat: repeat-x; display:block; visibility:visible; font-family: Arial; font-size: 9px; line-height:33px;color: #000;">
                        <?php $anchorAttribute = 'id="sys_yolacredit_a1" href="'.$footerLink.'" style="color:#000; display:inline; visibility: visible;font-family: Arial; font-size: 9px;" target="_blank"'; ?>
                        <?php $spanAttribute = 'id="sys_yolacredit_a2" style="color: #E7004F;display:inline;visibility:visible;font-family:Arial;font-size:9px;" target="_blank"'; ?>
