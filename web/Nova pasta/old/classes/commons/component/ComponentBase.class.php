 ...
 */
 ...
 abstract class ComponentBase {
     ...
     */
    public final function __construct(PageContext $pageContext, array $componentProperties) {
    ...
    public function renderTemplate($templateName) {
        ...
        if (_SYSTEM_MODE == "DESIGN") {
            ...
            if (_SYSTEM_ACTION != 'REFRESH') {
                ...
                echo '  <div class="sys_wrap" id="' . $this->getComponentProperty("id") . '_wrap" style="padding:2px; margin: 2px">';
                ...
                echo '                  <td style="width:20px; vertical-align:top;"><span id="' . $this->getComponentProperty("id") . '_delete" class="sys_wrap_x">x</span></td>';
                echo '              </tr>';
                echo '          </table>';
                echo '      </div>';
